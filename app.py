...
# ==============================================================================
# WIDGET INTELIGENT ALGORITM (ALINIAT PERFECT PENTRU COLOANĂ)
# ==============================================================================
with col_stinga:
    ...
    <div class="premium-card">
        ...
        <div class="cyber-grid">
            ...
            <div class="cyber-grid-item"><div class="cyber-num" style="color:#ffffff;">{m['med_gz']} : {m['med_os']}</div><div class="cyber-label">Medie Goluri</div></div>
