...
if st.session_state.ecran_login and not st.session_state.vip:
    ...
    with col_c2:
        ...
        parola = st.text_input("PAROLĂ SECURIZATĂ", placeholder="••••••••", type="password", key="lux_pass_v7")
        st.markdown("<div style='margin-top: 15px;'></div>", unsafe_allow_html=True)
        c_b1, c_b2 = st.columns(2)
        ...
        if c_b2.button("ÎNAPOI ↩️", key="btn_lux_back_v7"):
            st.session_state.ecran_login = False
            st.rerun()
        ...
        if not st.session_state.vip:
            ...
            if pachet_selectat == "🟢 PACHET LOW":
                ...
                <div class="pricing-card-lux pricing-border-low">
                    ...
                    <h2 style="margin:10px 0 20px 0; font-size:32px; color:#ffffff;">40 RON <span style="font-size:14px; color:#94a3b8; font-weight:600;">/ lună</span></h2>
                    <p style="margin:8px 0; color:#cbd5e1;">✅ 3 Bilete complet analizate pe săptămână</p>
                    <p style="margin:8px 0; color:#cbd5e1;">✅ Selecție exclusivă din ligile mari europene</p>
                    <a class="stripe-luxury-btn stripe-low-med" href="{link_stripe}" target="_blank">CUMPĂRĂ ACCES LOW 🚀</a>
                </div>
                """, unsafe_allow_html=True)
                ...
                <div class="pricing-card-lux pricing-border-medium">
                    ...
                    <h2 style="margin:10px 0 20px 0; font-size:32px; color:#ffffff;">70 RON <span style="font-size:14px; color:#94a3b8; font-weight:600;">/ lună</span></h2>
                    <p style="margin:8px 0; color:#cbd5e1;">✅ 1 Bilet Premium în fiecare zi calendaristică</p>
                    <p style="margin:8px 0; color:#cbd5e1;">✅ Algoritm avansat pentru probabilități live</p>
                    <a class="stripe-luxury-btn stripe-low-med" href="{link_stripe}" target="_blank">CUMPĂRĂ ACCES MEDIUM 🟡</a>
                </div>
                """, unsafe_allow_html=True)
                ...
                <div class="pricing-card-lux pricing-border-high">
                    ...
                    <h2 style="margin:10px 0 20px 0; font-size:32px; color:#ffffff;">120 RON <span style="font-size:14px; color:#94a3b8; font-weight:600;">/ lună</span></h2>
                    <p style="margin:8px 0; color:#cbd5e1;">✅ Cota 2 VIP zilnică + Proiect Dublare</p>
                    <p style="margin:8px 0; color:#cbd5e1;">✅ Monitorizare live non-stop pe sisteme</p>
                    <a class="stripe-luxury-btn stripe-high" href="{link_stripe}" target="_blank">DEBLOCHEAZĂ ACCES HIGH 🔥</a>
                </div>
                """, unsafe_allow_html=True)

            st.markdown("<div style='margin-top: 25px; text-align:center;'>", unsafe_allow_html=True)
            if st.button("🔐 ACCESEAZĂ CONT DETINUT", key="btn_trigger_final_v7"):
                st.session_state.ecran_login = True
                st.rerun()
        else:
            st.markdown(f"""
                <div class="vip-card-box" style="text-align: center; border: 1px solid #00ff66 !important; margin-top:25px;">
                    <h4 style="color:#00ff66; margin:0; font-weight:800;">🟢 CONEXIUNE SECURIZATĂ</h4>
                    <p style="color:#ffffff; margin:8px 0 0 0; font-size:16px;">Sesiune complet autorizată în sistem</p>
                </div>
            """, unsafe_allow_html=True)
