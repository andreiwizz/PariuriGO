...
if st.session_state.ecran_login and not st.session_state.vip:
    ...
    with col_stinga:
        ...
        st.components.v1.html(
            '<div style="border: 2px solid rgba(0, 255, 102, 0.3); border-radius: 20px; overflow: hidden; box-shadow: 0 15px 35px rgba(0,0,0,0.8); background: #111;"><iframe src="https://scorebat.com" style="width: 100%; height: 750px; border: none; background: #111;" allow="autoplay; fullscreen" loading="lazy"></iframe></div>',
            height=770,
            scrolling=False
        )
    ...
    with col_abonamente:
        if not st.session_state.vip:
            ...
            if pachet_selectat == "PACHET LOW":
                st.markdown(f'<div class="pricing-card-lux pricing-border-low"><h4 style="color:#00ff66; margin:0; font-weight:800;">PACHET LOW</h4><h2 style="margin:10px 0 20px 0; font-size:32px; color:#ffffff;">40 RON <span style="font-size:14px; color:#94a3b8; font-weight:600;">/ luna</span></h2><p style="margin:8px 0; color:#cbd5e1;">3 Bilete complet analizate pe saptamana</p><p style="margin:8px 0; color:#cbd5e1;">Selectie exclusiva din ligile mari europene</p><a class="stripe-luxury-btn stripe-low-med" href="{link_stripe}" target="_blank">CUMPARA ACCES LOW</a></div>', unsafe_allow_html=True)

            elif pachet_selectat == "PACHET MEDIUM":
                st.markdown(f'<div class="pricing-card-lux pricing-border-medium"><h4 style="color:#ffcc00; margin:0; font-weight:800;">PACHET MEDIUM</h4><h2 style="margin:10px 0 20px 0; font-size:32px; color:#ffffff;">70 RON <span style="font-size:14px; color:#94a3b8; font-weight:600;">/ luna</span></h2><p style="margin:8px 0; color:#cbd5e1;">1 Bilet Premium in fiecare zi calendaristica</p><p style="margin:8px 0; color:#cbd5e1;">Algoritm avansat pentru probabilitati live</p><a class="stripe-luxury-btn stripe-low-med" href="{link_stripe}" target="_blank">CUMPARA ACCES MEDIUM</a></div>', unsafe_allow_html=True)

            elif pachet_selectat == "HIGH VIP ELITE":
                st.markdown(f'<div class="pricing-card-lux pricing-border-high"><h4 style="color:#ff0055; margin:0; font-weight:800;">HIGH VIP ELITE</h4><h2 style="margin:10px 0 20px 0; font-size:32px; color:#ffffff;">120 RON <span style="font-size:14px; color:#94a3b8; font-weight:600;">/ luna</span></h2><p style="margin:8px 0; color:#cbd5e1;">Cota 2 VIP zilnica + Proiect Dublare</p><p style="margin:8px 0; color:#cbd5e1;">Monitorizare live non-stop pe sisteme</p><a class="stripe-luxury-btn stripe-high" href="{link_stripe}" target="_blank">DEBLOCHEAZA ACCES HIGH</a></div>', unsafe_allow_html=True)
