...
st.markdown('', unsafe_allow_html=True)st.markdown(f'{m["ht_gz"]}Peste 0.5 HT{m["ht_os"]}', unsafe_allow_html=True)st.markdown(f'{m["st_gz"]}Peste 0.5 ST{m["st_os"]}', unsafe_allow_html=True)st.markdown(f'{m["p15_gz"]}Peste 1.5 goluri{m["p15_os"]}', unsafe_allow_html=True)st.markdown(f'{m["p25_gz"]}Peste 2.5 goluri{m["p25_os"]}', unsafe_allow_html=True)st.markdown(f'{m["gg_gz"]}Ambele marchează{m["gg_os"]}', unsafe_allow_html=True)st.markdown(f'{m["c_gz"]}Peste 3.5 cartonașe{m["c_os"]}', unsafe_allow_html=True)st.markdown(f'{m["cor_gz"]}Peste 9.5 cornere{m["cor_os"]}', unsafe_allow_html=True)st.markdown('', unsafe_allow_html=True)st.markdown('', unsafe_allow_html=True)st.markdown('📈 BARE EVOLUȚIE PROBABILITĂȚI GENERALE GLOBAL:', unsafe_allow_html=True)st.markdown(f'Peste 1.5:<div class="bar-fill-neon" style="width: {m["w_p15"]};">{m["w_p15"]}', unsafe_allow_html=True)st.markdown(f'Peste 2.5:<div class="bar-fill-soft" style="width: {m["w_p25"]};">{m["w_p25"]}', unsafe_allow_html=True)st.markdown(f'Peste 0.5 R1:<div class="bar-fill-neon" style="width: {m["w_p05r1"]};">{m["w_p05r1"]}', unsafe_allow_html=True)st.markdown(f'Peste 0.5 R2:<div class="bar-fill-neon" style="width: {m["w_p05r2"]};">{m["w_p05r2"]}', unsafe_allow_html=True)st.markdown(f'Ambele marchează:<div class="bar-fill-neon" style="width: {m["w_gg"]};">{m["w_gg"]}', unsafe_allow_html=True)st.markdown(f'+ 3.5 Cartonașe:<div class="bar-fill-soft" style="width: {m["w_c35"]};">{m["w_c35"]}', unsafe_allow_html=True)st.markdown(f'+ 9.5 Cornere:<div class="bar-fill-soft" style="width: {m["w_cor95"]};">{m["w_cor95"]}', unsafe_allow_html=True)st.markdown(f'🔸Sistem Algoritm Automat PariuriGOToate procentele sunt verificate live pentru meciurile din data de {data_azi}', unsafe_allow_html=True)st.markdown('', unsafe_allow_html=True)4. SECȚIUNE ABONAMENTE VIP STRUCTURATĂ LINIAR (FĂRĂ TABURI - GARANTAT 100% VIZIBILE)with col_abonamente:st.subheader("🏆 Toate Abonamentele VIP")link_telegram_afacere = "t.me"# 1. LOWhtml_low = f"""🟢 PACHET LOW40 RON / lună✅ 3 Bilete gata analizate pe săptămână✅ Cote sigure selectate din ligile mari✅ Acces grup comunitate chatAbonare LOW 🚀"""st.markdown(html_low, unsafe_allow_html=True)# 2. MEDIUMhtml_med = f"""🟡 PACHET MEDIUM70 RON / lună✅ 1 Bilet Premium în fiecare zi✅ Procente și probabilități avansate live✅ Notificări instant pe TelegramAbonare MEDIUM 🟡"""st.markdown(html_med, unsafe_allow_html=True)# 3. HIGHhtml_high = f"""🔥 HIGH VIP ELITE120 RON / lună✅ Cota 2 VIP zilnică + Proiect Dublare✅ Acces total la toate sistemele noastre✅ Suport privat 1-la-1 direct cu tipsterulDeblochează HIGH 🔥"""st.markdown(html_high, unsafe_allow_html=True)
