...
def aplica_stiluri_champions():
    # Link online stabil către imaginea premium cu trofeul Champions League
    ...
    <style>
        ...
        .stApp {{
            background: linear-gradient(rgba(10, 5, 28, 0.93), rgba(4, 2, 15, 0.96)), url('{bg_url}') !important;
        ...
        /* Panoul de Login din Sidebar - Asortat Complet pe Mov */
        section[data-testid="stSidebar"] {{
            background-color: #0b071e !important;
            border-right: 1px solid rgba(157, 0, 255, 0.3) !important;
        }}
        
        /* Panoul Central - Negru complet identic cu aplicația */
        .glass-box-container {{
            background: #000000 !important;
            border: 1px solid #1a0f30 !important;
            border-radius: 16px !important;
            padding: 24px !important;
            box-shadow: 0 20px 40px rgba(157, 0, 255, 0.15) !important;
            margin-bottom: 25px !important;
        }}

        /* Casetă pachete VIP din dreapta */
        .vip-card-box {{
        ...
        /* Insignele procentajelor - Mov VIP Premium */
        .mov-badge-tiktok {{
        ...
        /* Barele orizontale de progres - Stil aplicație */
        .bar-wrapper {{ margin: 14px 0; }}
        .bar-container-custom {{ width: 100%; background: #130d24; border-radius: 20px; height: 22px; overflow: hidden; border: 1px solid #281947; }}
        ...
        /* Butoane mari native Streamlit forțate pe Mov */
